...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "/docker":         { target: "http://127.0.0.1:7070", changeOrigin: true, secure: false },
      "/summary":        { target: "http://127.0.0.1:7070", changeOrigin: true, secure: false },
      "/report":         { target: "http://127.0.0.1:7070", changeOrigin: true, secure: false },
      ...
      "/_svc/workflows/v1":     { target: `http://${HOST}:8098`, changeOrigin: true, rewrite: (p) => p.replace(/^\/_svc\/workflows/, "") },
      "/_svc/workflows/assets": { target: `http://${HOST}:5178`, changeOrigin: true },
