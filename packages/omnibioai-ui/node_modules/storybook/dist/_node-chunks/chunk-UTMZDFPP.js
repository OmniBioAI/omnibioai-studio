...
import {
  ...
  toPath,
  traversePathUp
} from "./chunk-LU3JS5YC.js";
import {
  versions_default
} from "./chunk-F2JWHUG3.js";
import {
  logger
} from "./chunk-S3URB77E.js";
import {
  BUN_LOCKFILE,
  BUN_LOCKFILE_BINARY,
  NPM_LOCKFILE,
...
async function scanAndTransformFiles({
  ...
  let globby = (await import("./globby-BKONZQFM.js")).globby, sourceFiles = await globby([glob2], {
    ...commonGlobOptions(""),
    ignore: ["**/node_modules/**"],
    dot: !0,
    cwd: getProjectRoot(),
...
var transformImportFiles = async (files, renamedImports, dryRun) => {
  let errors = [], { default: pLimit } = await import("./p-limit-FPF4MEPV.js"), limit = pLimit(10);
  return await Promise.all(
    files.map(
      (file) => limit(async () => {
        try {
