import CJS_COMPAT_NODE_URL_vs915kjs9b from 'node:url';
import CJS_COMPAT_NODE_PATH_vs915kjs9b from 'node:path';
import CJS_COMPAT_NODE_MODULE_vs915kjs9b from "node:module";

var __filename = CJS_COMPAT_NODE_URL_vs915kjs9b.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_vs915kjs9b.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_vs915kjs9b.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-4LNMM2E5.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-DFFBXVX7.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-AOWVZDII.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-RYKC3ZWO.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
