...
import {
  compile
} from "./chunk-3H3KO44A.js";
import "./chunk-C3QXXDS3.js";
import "./chunk-2QZ5RUHT.js";
import {
  __commonJS,
  __toESM
} from "./chunk-4LNMM2E5.js";
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-DFFBXVX7.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-AOWVZDII.js")).default;
  return {
