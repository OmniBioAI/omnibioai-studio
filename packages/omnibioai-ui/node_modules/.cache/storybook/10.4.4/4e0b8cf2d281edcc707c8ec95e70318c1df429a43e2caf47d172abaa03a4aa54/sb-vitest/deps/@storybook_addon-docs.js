import { pt as __export } from "./blocks-C8R-kTQO.js";
import { t as definePreviewAddon10 } from "./csf-DhnoPZiI.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-B6aqOsRx.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-oIlotey5.js");
