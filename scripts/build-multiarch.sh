...
IMAGES=(
  ...
  "tool-images|omnibioai-tool-images|Dockerfile|omnibioai-tool-images:latest"
  "tes|omnibioai-tes|Dockerfile|omnibioai-tes:latest"
  "rag|omnibioai-rag|Dockerfile|omnibioai-rag:latest"
  "dev-hub|omnibioai-dev-hub|Dockerfile|omnibioai-dev-hub:latest"
  "model-registry|omnibioai-model-registry|Dockerfile|omnibioai-model-registry:latest"
  "toolserver|omnibioai-toolserver|Dockerfile|omnibioai-toolserver:latest"
  "lims|omnibioai-lims|Dockerfile|omnibioai-lims:latest"
  "videos|omnibioai-videos|Dockerfile|omnibioai-videos:latest"
  "sdk|omnibioai_sdk|Dockerfile|omnibioai-sdk:latest"
  "control-center|omnibioai-control-center|Dockerfile|omnibioai-control-center:latest"
